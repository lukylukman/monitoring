    ...
    <div class="container flex justify-between items-center px-6 mx-auto h-full text-blue-600 md:justify-end">
        ...
        <x-dropdown>
            <x-slot name="trigger">
                ...
                <button class="align-middle hover:scale-105 hover:fill-blue-700 duration-200 rounded-full focus:shadow-outline-blue focus:outline-none" @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
