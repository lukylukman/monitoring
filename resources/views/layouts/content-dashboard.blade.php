...
<head>
    ...
    @vite(['resources/css/tailwind.min.css', 'resources/js/chard.bundle.min.js'])
        <!-- Scripts -->
        <script src="{{ asset('js/init-alpine.js') }}"></script>
        <link rel="stylesheet" href="{{('../css/tailwind.min.css')}}"/>
        <link rel="stylesheet" href="{{('../js/chard.bundle.min.js')}}"/>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
    <link rel="stylesheet" href="../css/tailwind.min.css"/>
    <!--Replace with your tailwind.css once created-->
    <script src="../js/chart.bundle.min.js" integrity="sha256-XF29CBwU1MWLaGEnsELogU6Y6rcc5nCkhhx89nFMIDQ=" crossorigin="anonymous"></script>
