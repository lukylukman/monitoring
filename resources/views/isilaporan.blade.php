                        ...
                        @foreach ($isilaporan as $isi)
                          ...
                          <td align="center" >
                              <form method="post" action="/isilaporan/{{ $isi->nopo }}">
                                  @csrf
                                  @method('delete')
                                  <button class="btn btn-danger" type="submit" value="Hapus" id="delete" name="delete" onclick="return confirm('Anda yakin ingin menghapus data?')"><i data-feather="trash-2"></i></button>
                              </form>
                          </td>
